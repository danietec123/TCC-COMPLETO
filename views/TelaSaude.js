...
const TelaSaude = () => {
  ...
  navigation.navigate('Perfil'); /*aqui vai quando eu apertar o botao adicionar ele vai direcionar para a tela perfil,const handleAdicionar = () => {  tentando fazer essa parte
    navigation.navigate('Perfil', {
      tipoConsulta: selectedItem1,
      detalhesConsulta: selectedItem2,
